...
public class ExRayCast : MonoBehaviour
{
    ...
    public GameObject TargetObject;                                          //타겟 프리팸
    ...
    void Update()
    {
        ...
        if (CheckTime >= 0.5f)                                               //0.5초 마다 행동을 한다.
        {
            ...
            GameObject temp = Instantiate(TargetObject);                     //instantiacte 함수를 통해서 프리맵을 생성한다.
        ...
        if (Input.GetMouseButtonDown(1))                                     //마우스 오른쪽 버튼이 눌렀을 경우
        {
