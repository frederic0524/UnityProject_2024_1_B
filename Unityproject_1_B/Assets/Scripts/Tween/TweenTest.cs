...
public class TweenTest : MonoBehaviour
{
    ...
    void Start()
    {
        //transform.DOMoveX(5, 2);  //Tween을 통해서 오브젝트는 X축으로 2초동안 5만큼 간다.

        //transform.DORotate(new Vector3(0, 0, 180), 0.3f); //Tween을 통해서 오브젝트를 X축으로 0.5초동안 180도 만큼 회전한다.
        ...
        //transform.DOMoveX(5, 0.5f).SetEase(Ease.OutBounce);            //이동할때 효과를 추가 시킬 수 있다. (Ease.OutBounce)
    ...
    void DeactivateObject()    //연출 종룓힌 이후에 함수를 호출
    {
